Bem-vindo ao meu projeto de **Gestão de Inventário**! Este é um sistema simples para gerenciar produtos e calcular o valor total do estoque, desenvolvido em Django.
